	...
	<tr>
		...
		<table width="760" height="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<img src="<?php echo $this->load->config->item('base_url') . $this->load->config->item('inc_folder');?>images/church/banner.png"
			...
			<tr>
				...
				<ul id="menu">
					...
					<li><a href="<?php echo site_url('laporan/getDataLaporanIndividuNew');?>">Laporan</a>
						<!--<ul>
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td height="1" class="bottom_addr">&copy; 2017 Gereja Kristen Injili di Tanah Papua
