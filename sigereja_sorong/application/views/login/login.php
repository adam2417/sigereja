...
<body>
	<div id="page" align="center">
		<div id="header">
			...
			<marquee>Selamat datang di aplikasi Sistem Informasi Gereja.</marquee>
			</div>			
		</div>
		<br />
		<div id="content">
			...
			<div id="contenttext">
				...
				<span class="subtitle_gray">Gereja</span><br />
				<br />
				<p class="body_text" align="justify">Aplikasi ini digunakan untuk memberikan informasi seputar
				Gereja yang kita cintai ini. Informasi disajikan terhadap pengguna dengan disesuaikan pada kondisi yang ada saat ini.
				<br /><br />
